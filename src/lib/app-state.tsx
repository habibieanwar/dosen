...
export const MODELS: { id: ModelId; label: string; desc: string }[] = [
  { id: "chat-biasa", label: "Chat Biasa", desc: "Tanya jawab umum" },
  { id: "proposal-penelitian", label: "Proposal Penelitian", desc: "Bantu susun dan revisi proposal" },
  { id: "riset-akademik", label: "Riset Akademik", desc: "Cari referensi dan metodologi" },
  { id: "hasil-penelitian", label: "Hasil Penelitian", desc: "Analisis dan diskusi temuan" },
];
